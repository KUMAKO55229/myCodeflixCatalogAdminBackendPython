...
class TestUpdateCategory:
    def test_update_category_with_name_and_description(self):
        ...
        category.update_category(name= "Série", description="Series em geral")

        assert category.name=="Série"
        assert category.description == "Series em geral"

    def test_update_category_with_invalid_name_raises_exeception(self): 
        category = Category(name= "Filme", description="Filme em geral") 
    ...
    def test_cannot_update_category_with_empty_name(self) : 
        ...
        with  pytest.raises(ValueError, match="name cannot be empty") :
            category.update_category(name="",description="Filme em geral")
